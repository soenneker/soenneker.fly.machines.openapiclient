...
namespace Soenneker.Fly.Machines.OpenApiClient.Models
{
    ...
    public partial class FlyContainerConfigRestart : IAdditionalDataHolder, IParsable
    {
        ...
        /// </summary>
        public FlyContainerConfigRestart()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Fly.Machines.OpenApiClient.Models.FlyContainerConfigRestart"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Fly.Machines.OpenApiClient.Models.FlyContainerConfigRestart CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Fly.Machines.OpenApiClient.Models.FlyContainerConfigRestart();
        }
        /// <summary>
